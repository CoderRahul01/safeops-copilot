...
const processIntent = async (req, res) => {
  try {
    ...
    // 🛡️ Sentinel: Prevent information disclosure by returning a generic error message instead of error.message
...
const advanceIntent = async (req, res) => {
    try {
        ...
        console.error('❌ [Intent Controller] Advance intent error:', error.message);
        // 🛡️ Sentinel: Prevent information disclosure by returning a generic error message instead of error.message
